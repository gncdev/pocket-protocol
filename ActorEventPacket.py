...
class ActorEventPacket(all.DataPacket):
	NETWORK_ID = ProtocolInfo.ACTOR_EVENT_PACKET
	...
	def handle(self, session: all.NetworkSession) -> bool:
		return session.handleActorEvent()
